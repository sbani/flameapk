...
cat << "EOF"
  ...
  [____________________]' `\_,/'/
    ...
    ||| \       __/_||  __||__
-----||-/------`-._/||-o--o---o---
> \ /           Flameapk :  A.I for Android Application Security
...
python3 flameapk.py $dist_dir $Tool
echo "[+] Data Dumped : OK"
echo "[+] Results     : In folder Results/"
echo "[+] Results     : In folder Results/apk_program_name"
./AI_checker.sh
echo "";
echo "";
